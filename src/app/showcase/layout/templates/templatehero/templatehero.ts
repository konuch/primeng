        ...
        <div class="template-hero">
            ...
            <div class="template-hero-card">
                ...
                <div class="template-hero-card-buttons">
                    <a [href]="$safeNavigationMigration(templateHeroData?.liveHref)" target="_blank" class="template-hero-card-buttons-btn1 p-button"> Live Demo </a>
                ...
                <div class="template-hero-card-links ">
                    ...
                    <a [href]="$safeNavigationMigration(templateHeroData?.docHref)" target="_blank">
            ...
            <ng-container *ngIf="!!templateHeroData?.dashboard1">
                <img class="template-hero-dashboard1" eager [src]="$safeNavigationMigration(templateHeroData?.dashboard1)" alt="Template Dashboard Image 1" />
            </ng-container>
            <ng-container *ngIf="!!templateHeroData?.dashboard2">
                <img class="template-hero-dashboard2" eager [src]="$safeNavigationMigration(templateHeroData?.dashboard2)" alt="Template Dashboard Image 2" />
            </ng-container>
        </div>
    `,
