        ...
        <ng-template [ngIf]="node">
            ...
            >
                ...
                >
                    ...
                    <div class="p-checkbox p-component" [attr.aria-label]="tree.selectNodeAriaLabel" [ngClass]="{ 'p-checkbox-disabled': node.selectable === false }" *ngIf="tree.selectionMode == 'checkbox'" aria-hidden="true">
                        <div class="p-checkbox-box" [ngClass]="{ 'p-highlight': isSelected(), 'p-indeterminate': node.partialSelected }" role="checkbox" [attr.aria-checked]="isSelected()">
